          ...
          <template #header-slot>
            <header class = 'header-row'>
              ...
              <div class = 'header-row-cell header-search-type row-cell-right margin-10'>
                <button class ='btn-normal' @click.stop="onSearch"> 
                  <div class="btnDiv">
                    <SearchIcon :width ="15" :height = "15" iconColor="white"></SearchIcon>
                    <div class="btn-content">검색하기</div>
                  </div>
                </button>
                <button class ='btn-normal' @click.stop="onRefresh" > 
                  <div class="btnDiv">
                    <ReloadIcon :width ="15" :height = "15" iconColor="white"></ReloadIcon>
                    <div class="btn-content">새로고침</div>
                  </div>
                </button>
              </div>
            </header>
...
export default defineComponent({
  ...
  setup(props, context) {
    ...
    const extractList: Ref<any[]> | undefined = inject('extractList') as Ref<any[]>;
    ...
    const totalCount = computed(() => extractList.value.length);
